    ...
    <div className="min-h-screen pb-12">
      ...
      <main className="mx-auto max-w-2xl px-4 sm:px-6">
        ...
        <footer className="mt-10 flex flex-col items-center gap-2 text-center text-xs text-slate-400">
          <div>© {t.footer.year} · {t.footer.poweredBy}</div>
          <a
            href="/admin"
            className="inline-flex items-center gap-1 rounded-md px-2 py-1 text-slate-400 transition hover:bg-slate-100 hover:text-ieee"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
            ...
            <span>{lang === 'ar' ? 'لوحة الإدارة' : 'Admin dashboard'}</span>
          </a>
        </footer>
      </main>
    </div>
